...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  const bringToFrontRef = useRef<((cardIndex: number) => void) | null>(null);
  ...
  useEffect(() => {
    ...
    const bringToFront = (cardIndex: number) => {
      ...
      const positionInOrder = order.current.indexOf(cardIndex);
    ...
    // Store bringToFront in ref so it can be accessed by onClick handlers
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as React.ReactElement<any>, {
          key: i,
          ref: refs[i],
          style: { width, height, ...((child.props as any).style ?? {}), cursor: 'pointer' },
