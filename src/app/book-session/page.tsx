    ...
    <div className="relative min-h-screen bg-primary-700 pt-24 pb-12">
      ...
      <div className="container-main relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <CalendlyWidget 
            url="https://calendly.com/rupika2020-aattamnirvana/90-minute-coaching-session"
            iframeSrc="https://calendly.com/rupika2020-aattamnirvana/90-minute-coaching-session?embed_domain=localhost&embed_type=Inline"
          />
        </div>
      </div>
    </div>
